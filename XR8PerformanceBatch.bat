...
:: Batch File Log
echo XR8's Performance Batch Log >APB_Log.txt
...
powershell -ExecutionPolicy Bypass -Command "Checkpoint-Computer -Description 'XR8 Performance Batch' -RestorePointType 'MODIFY_SETTINGS'" >> APB_Log.txt
...
echo.
echo.
echo                           [1] Performance Optimizations                 [2] KBM Optimizations
echo. 
echo.
echo                           [3] Disable Telemetry                         [4] Network
echo.
echo.
echo                           [5] Debloat Windows                           [6] Other
...
curl -g -k -L -# -o "%temp%\nvidiaProfileInspector.zip" "https://github.com/xr8/perf-suite >> APB_Log.txt
...
echo                          %w%╚═╝░░╚═╝╚═╝░░╚═╝░╚════╝░  ░░░╚═╝░░░░░░╚═╝░░░╚═╝░░╚══════╝╚═╝░░╚═╝╚═╝░░╚═╝╚══════╝╚═╝░░╚═╝%t%
echo.
echo                                                 %w%Created By: .4ez.%t%
echo                                                      %w%Version: 1.0%t%
echo.
echo %w%═══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════%t%
...
echo.
echo.
echo                          [1] Remove Powershell Packages                  [2] Disable Cortana
echo. 
echo.
echo                          [3] Disable Unnecessary Services                [4] Disable OneDrive
echo.
echo.
echo                          [5] PC Cleaner                                  [6] Go Back to Menu                                                        
set choice=
set /p choice=
if not '%choice%'=='' set choice=%choice:~0,1%
...
echo                                         [1] Disable Drivers     [2] KBoost
echo.
echo.
echo                                         [3] Menu
set choice=
